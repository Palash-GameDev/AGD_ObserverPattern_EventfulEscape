...
public class LightSwitchView : MonoBehaviour, IInteractable
{
    ...
    private void OnEnable()
    {
        ...
        EventService.Instance.OnLightsOffByGhostEvent.AddListener(onLightTurnedByGhost);
    }

    private void OnDisable()
    {
        EventService.Instance.OnLightSwitchToggled.RemoveListener(onLightSwitch);
        EventService.Instance.OnLightsOffByGhostEvent.RemoveListener(onLightTurnedByGhost);
    }
    ...
    private void onLightTurnedByGhost()
    {
        OnSetLight(false);
        GameService.Instance.GetSoundView().PlaySoundEffects(SoundType.SwitchSound);
    ...
    private void OnSetLight(bool lights)
    {
        foreach (Light lightSource in lightsources)
        {
            lightSource.enabled = lights;
