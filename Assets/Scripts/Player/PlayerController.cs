...
public class PlayerController
{
    ...
    public PlayerController(PlayerView playerView, PlayerScriptableObject playerScriptableObject)
    {
        ...
        EventService.Instance.OnLightsOffByGhostEvent.AddListener(OnlightsTurnedByGhost);
    }
    ...
    ~PlayerController()
    {
        ...
        EventService.Instance.OnLightsOffByGhostEvent.RemoveListener(OnlightsTurnedByGhost);
    }
    ...
    private void OnlightsTurnedByGhost()
    {
        playerState = PlayerState.InDark;
    }
